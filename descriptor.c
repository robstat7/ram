...
void init_gdt(void)
{
	gdt_ptr_var.limit = (sizeof(gdt_entry_t) * 7) - 1;
	gdt_ptr_var.base = gdt_entries;
...
void init_idt(void)
{
	idt_ptr_var.limit = sizeof(idt_entry_t) * 256 - 1;
	idt_ptr_var.base = idt_entries;
